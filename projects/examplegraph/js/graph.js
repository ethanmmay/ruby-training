...
var Albertsons = [100, 102, 87, 100, 100, 123, 100, 90, 87, 91, 93, 88];
...
function update() {
    ...
    if (company === "Albertsons") {
        /*
         * Erase current graph (how?) or redraw the graph
         * Then draw new graph with the code below
         */
    ...
    // You can add code here to draw a clean graph (3 lines)
    // But there are other ways to do this task
